...
#Question1: Can the input test cases be regrouped to make orderedTree?


    #Test cases that are NOT ordered but can be regrouped into ordered Tree
notorderedN1 = "(((((2,1),3),4),5),6)"
notorderedI1 = "[1,2],[1,3],[1,4][1,5][1,6]"


    #Test cases that are NOT ordered and CANNOT be regrouped into ordered Tree
...
#Question 3: What if input is a string in lists of lists or string interval form?
